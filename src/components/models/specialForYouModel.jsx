                            ...
                            <div className="border rounded-md mb-4 bg-[linear-gradient(180deg,#e7f3e6,#f6fbf5)] p-4 border-[#d5ead3]">
                                ...
                                <ul className="text-[14px] mt-4 pl-4 flex flex-col gap-2 list-disc list-outside">
                                    <li className="text-[13px]">
                                        Items purchased from Dressfair are eligible for our price adjustment policy. Dressfair will provide the price difference in the currency that the order was paid in if the selling price of the item purchased was reduced within 30 days of payment in the same country or region. The shipment of your order will not be affected by applying for a price adjustment before you receive your item(s). You can request a price adjustment refund by selecting the relevant order in 'Your Orders' and clicking on the 'Price adjustment' button.
                                    </li>
                                    <li className="text-[13px]">
                                        Items that are promotional or no longer available may not be eligible for our price adjustment policy. Fees, including but not limited to shipping fees, will be excluded for any price adjustment calculation. Dressfair reserves the right to the final interpretation of our price adjustment policy, the right to modify the terms of this policy at any time, and the right to deny any price adjustment at our sole discretion.
                                    </li>
                                </ul>
                            </div>
                        </div>
