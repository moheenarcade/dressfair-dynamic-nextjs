...
const Notifications = () => {
  ...
  const renderContent = () => {
    switch (activeModal) {
            ...
            {!emailEnabled ? (
              <div>
                ...
                <div className="pt-6 border-b border-b-gray-200">
                  ...
                  <Image className="mx-auto w-60 mt-4" src="/promotional-model-img.avif" alt="promotion" width={100} height={100} />
                </div>

                <div className="py-6 border-b border-b-gray-200">
                  <p className="text-[17px] text-[#222] font-[500] mb-2">In-app notifications</p>
                  <p className="text-start text-[#757575] text-[14px] font-[500]">
      ...
      case "activity":
        return <p>Edit customer activity visibility here.</p>;
      case "avatar":
        return <p>Edit avatar & username sharing options.</p>;
      default:
        return null;
    }
  };
  ...
  return (
    <>
      <div className="px-4 lg:px-0">
        <div className="bg-[#0a8800] py-2 px-3 rounded-lg flex items-center gap-2">
          ...
          <h1 className='text-md text-white font-semibold'>Dressfair does not ask customers for additional fees via SMS or email.</h1>
        </div>
        <div className="notification-sec pt-2 pb-12">
          <div className="single-noti border-b border-b-gray-200 py-4">
            <h2 className='text-[#222] text-[16px] font-semibold'>Promotions</h2>
            <p className='text-[#757575] text-[14px] font-[500]'>
              Be the first to learn about promotions, daily deals, and other exclusive savings.
            </p>
            <div className="flex items-center justify-between pt-4">
              <p className='text-[#222] text-[14px] font-[500]'>Off: Email</p>
              <button
                onClick={() => openModal("promotions")}
                className="text-[15px] text-[#222] font-[500] border border-gray-300 hover:border-black py-1 px-6 rounded-full"
              >
                Edit
              </button>
            </div>
          ...
          <div className="single-noti border-b border-b-gray-200 py-4">
            <h2 className='text-[#222] text-[16px] font-semibold'>Order updates</h2>
            <p className='text-[#757575] text-[14px] font-[500]'>
          ...
          <div className="single-noti border-b border-b-gray-200 py-4">
            <h2 className='text-[#222] text-[16px] font-semibold'>Chat messages</h2>
            <p className='text-[#757575] text-[14px] font-[500]'>
              Never miss important messages from sellers.</p>
            <div className="flex items-center justify-between pt-4">
              <p className='text-[#222] text-[14px] font-[500] flex items-center gap-2'>Off: Email <span className='flex w-px h-4 bg-gray-300'></span> Off: SMS</p>
              <button
          ...
          <div className="single-noti border-b border-b-gray-200 py-4">
            <h2 className='text-[#222] text-[16px] font-semibold'>Customers' activity</h2>
            <p className='text-[#757575] text-[14px] font-[500]'>
              Keep up with the latest shopping trends.
            </p>
            <div className="flex items-center items-center justify-between pt-4">
              <p className='text-[#222] text-[14px] font-[500]'>On: Showing others' shopping activities.
              </p>
              <button
          ...
          <div className="single-noti border-b border-b-gray-200 py-4">
            <h2 className='text-[#222] text-[16px] font-semibold'>Avatar and username sharing</h2>
            <p className='text-[#757575] text-[14px] font-[500]'>
