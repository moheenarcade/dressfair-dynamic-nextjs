...
const CartItemsDetailCheckoutMobile = ({ isOpen, onClose , currency }) => {
    const {
        cartItems,
        updateQty,
        toggleSingle,
                                        ...
                                        <div className="flex flex-col justify-between">
                                            ...
                                            <div className="flex justify-between w-full items-center border-b border-b-gray-200">
                                                <div className="text-center text-[#fb7701] text-[16px] lg:text-2xl font-semibold py-2 flex items-center gap-1">
                                                    <span className="text-[12px] lg:text-xl">{currency || "AED"}.</span>{item.sale_price}
                                                    <p className="text-[#757575] text-[11px] lg:text-lg font-normal relative"><span className="absolute top-[8px] lg:top-[13] bg-[#FB7701] w-full h-[2px]"></span>{currency || "AED"}.{item.price}</p>
