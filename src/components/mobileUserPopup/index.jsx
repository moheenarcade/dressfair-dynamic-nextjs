            ...
            <div className='bg-white rounded-[5px] shadow-lg z-[999999999999999999] left-0 right-0 md:right-4 -mt-2 absolute w-[90%] md:w-[400px] mx-auto md:mr-0 border-[1px] border-[#dfdfdf]'>
                <div className="relative">
                    ...
                    <ul className='px-4'>
                        ...
                        <Link href={withCountry("/user/followed-stores")} onClick={onClose}>
                            <li className='cursor-pointer flex items-center gap-1 text-[15px] font-normal py-3 border-b border-b-gray-200'>
                        ...
                        <Link href={withCountry("/user/browsing-history")} onClick={onClose}>
                            <li className='cursor-pointer flex items-center gap-1 text-[15px] font-normal py-3 border-b border-b-gray-200'>
                        ...
                        <Link href={withCountry("/user/addresses")} onClick={onClose}>
                            <li className='cursor-pointer flex items-center gap-1 text-[15px] font-normal py-3 border-b border-b-gray-200'>
                        ...
                        <Link href={withCountry("#")} onClick={onClose}>
                        <li className='cursor-pointer flex items-center gap-1 text-[15px] font-normal py-3 border-b border-b-gray-200'>
                        ...
                        <Link href={withCountry("/user/country-region-language")} onClick={onClose}>
