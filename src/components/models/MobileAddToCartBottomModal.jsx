...
`}
                              >
                                ...
                                {hoveredSizeId === sizeObj.product_option_id && (
                                  <div className="absolute bottom-full left-[120%] -translate-x-1/2 mb-2 px-2 py-1 text-xs text-white bg-black rounded shadow-md whitespace-nowrap z-[9899999999999]">
