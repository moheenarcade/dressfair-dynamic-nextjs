...
//               {cartItems.map((item) => (
//                 <div key={`${item.product_id}-${item.color.sku}-${item.size.product_option_id}`} className="single-item">
...
//                               onClick={() =>
//                                 updateQty(item.product_id, item.color.sku, item.size.product_option_id, qty)
//                               }
//                             >
//                               {qty}
//                             </motion.li>
...
//                               onClick={() => {
//                                 if (qty === 0) {
//                                   removeItem(item.product_id, item.color.sku, item.size.product_option_id);
//                                 } else {
//                                   updateQty(item.product_id, item.color.sku, item.size.product_option_id, qty);
//                                 }
//                                 setOpenQtyId(null); // close dropdown after selection
//                               }}
//                             >
//                               {qty}
//                             </motion.li>
                        ...
                        >
                          {qtyOptions.map((qty) => (
                            <motion.li
                              ...
                              whileHover={{ backgroundColor: "#f3f3f3" }}
                              className={`px-3 py-2 text-sm cursor-pointer font-semibold ${
                                qty === 0 ? "text-red-500 hover:text-red-600" : ""
                              }`}
